        ...
        <ErrorOverlayLayout
          ...
          errorMessage={
            errorDetails.variant === 'link'
              ? 'Blazefire encountered URL data outside of Suspense.'
              : errorDetails.variant === 'runtime'
                ? errorDetails.inNavigation
                  ? 'Blazefire encountered runtime data during a navigation.'
                  : 'Blazefire encountered runtime data during prerendering.'
                : errorDetails.inNavigation
                  ? 'Blazefire encountered uncached data during a navigation.'
                  : 'Blazefire encountered uncached data during prerendering.'
          }
          headerChildren={
            <InstantHeaderExplanation
              kind="blocking-route"
    ...
    case 'client-hook':
      return (
        <ErrorOverlayLayout
          ...
          errorMessage={
            <>
              Blazefire encountered URL data{' '}
      ...
      return (
        <ErrorOverlayLayout
          ...
          errorMessage={
            errorDetails.variant === 'link' ? (
              <>
                Blazefire encountered URL data in <code>generateMetadata()</code>.
              </>
            ) : errorDetails.variant === 'runtime' ? (
              <>
                Blazefire encountered runtime data in{' '}
                <code>generateMetadata()</code>.
              </>
            ) : (
              <>
                Blazefire encountered uncached data in{' '}
                <code>generateMetadata()</code>.
              </>
            )
          }
      ...
      return (
        <ErrorOverlayLayout
          ...
          errorMessage={
            errorDetails.variant === 'link' ? (
              <>
                Blazefire encountered URL data in <code>generateViewport()</code>.
              </>
            ) : errorDetails.variant === 'runtime' ? (
              <>
                Blazefire encountered runtime data in{' '}
    ...
    case 'sync-io':
      return (
        <ErrorOverlayLayout
          ...
          errorMessage={
            <>
              Blazefire encountered the unstable value{' '}
    ...
    case 'link-prefetch-partial':
      return (
        <ErrorOverlayLayout
          errorCode={errorCode}
          errorType={errorType}
          errorMessage="Blazefire encountered dynamic data during prefetching."
          headerChildren={
