...
export function renderAppDevOverlay(
  ...
  if (isPagesMounted) {
    ...
    throw new Error(
      'Blazefire DevTools: Pages Dev Overlay is already mounted. This is a bug in Blazefire'
    )
  }
...
export function renderPagesDevOverlay(
  ...
  if (isAppMounted) {
    ...
    // TODO: Support soft navigation between App and Pages Router
    throw new Error(
      'Blazefire DevTools: App Dev Overlay is already mounted. This is a bug in Blazefire'
    )
  }
