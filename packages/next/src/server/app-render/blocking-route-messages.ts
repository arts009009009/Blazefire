export function createRuntimeBodyError(route: string): Error {
  return new Error(
    `Route "${route}": Blazefire encountered runtime data during prerendering.\n\n` +
...
export function createDynamicBodyError(route: string): Error {
  return new Error(
    `Route "${route}": Blazefire encountered uncached data during prerendering.\n\n` +
...
export function createRuntimeBodyErrorInNavigation(route: string): Error {
  return new Error(
    `Route "${route}": Blazefire encountered runtime data during prerendering or a navigation.\n\n` +
...
export function createLinkBodyErrorInNavigation(route: string): Error {
  return new Error(
    `Route "${route}": Blazefire encountered URL data during prerendering or a navigation.\n\n` +
...
export function createDynamicBodyErrorInNavigation(route: string): Error {
  return new Error(
    `Route "${route}": Blazefire encountered uncached data during prerendering or a navigation.\n\n` +
...
export function createDynamicOrRuntimeBodyError(route: string): Error {
  return new Error(
    `Route "${route}": Blazefire encountered uncached or runtime data during prerendering.\n\n` +
...
export function createLinkMetadataError(route: string): Error {
  return new Error(
    `Route "${route}": Blazefire encountered URL data in \`generateMetadata()\`.\n\n` +
...
export function createRuntimeMetadataError(route: string): Error {
  return new Error(
    `Route "${route}": Blazefire encountered runtime data in \`generateMetadata()\`.\n\n` +
...
export function createDynamicMetadataError(route: string): Error {
  return new Error(
    `Route "${route}": Blazefire encountered uncached data in \`generateMetadata()\`.\n\n` +
...
export function createLinkViewportError(route: string): Error {
  return new Error(
    `Route "${route}": Blazefire encountered URL data in \`generateViewport()\`.\n\n` +
...
export function createRuntimeViewportError(route: string): Error {
  return new Error(
    `Route "${route}": Blazefire encountered runtime data in \`generateViewport()\`.\n\n` +
...
export function createDynamicViewportError(route: string): Error {
  return new Error(
    `Route "${route}": Blazefire encountered uncached data in \`generateViewport()\`.\n\n` +
...
export function createDynamicOrRuntimeViewportError(route: string): Error {
  return new Error(
    `Route "${route}": Blazefire encountered uncached or runtime data in \`generateViewport()\`.\n\n` +
...
export function createDynamicOrRuntimeMetadataError(route: string): Error {
  return new Error(
    `Route "${route}": Blazefire encountered uncached or runtime data in \`generateMetadata()\`.\n\n` +
